...
const Footer = () => {
    return (
        <div>
            <footer className=" grid  grid-cols-3 footer p-10 bg-base-200 text-base-content">
                <nav>
            ...
            <footer className=" grid grid-cols-2 footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
