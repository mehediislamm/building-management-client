...
const CheckoutForm = () => {
    ...
    const totalRent = cart.reduce((total, item) => total + item.rent, 0)
        ...
        if (confirmError) {
            ...
            if (paymentIntent.status === 'succeeded') {
                ...
                const payment = {
                    ...
                    data: new Date(),
                    cartIds: cart.map(carts => carts._id),
                    dataIds: cart.map(carts => carts.dataId),
                    status: "pending",
                }
                ...
                if(res.data?.paymentResult?.insertedId){
                    Swal.fire({
                        position: "top-end",
                        icon: "success",
                        title: "Thanks you for the payment",
